package com.example.ctgu.login_test.pintu.view;
...
import com.example.ctgu.login_test.utils.ImagePiece;
import com.example.ctgu.login_test.utils.ImageSplitterUtil;
...
public class GamePintuLayout extends RelativeLayout implements OnClickListener
{
	...
	private void checkSuccess()
	{
		...
		if (isSuccess)
		{
			...
			Toast.makeText(getContext(), "成功升到下一级!",
